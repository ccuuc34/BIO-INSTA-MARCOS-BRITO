...
// Logo do botão flutuante de Suporte Prioritário — headset + selo de prioridade,
// não é o ícone do WhatsApp de propósito, pra deixar claro que é o canal certo.
const IconSupportFab = () => (
  <svg viewBox="0 0 24 24" width="26" height="26" fill="none">
    <path d="M12 3a7 7 0 00-7 7v3.5a1.5 1.5 0 001.5 1.5H7v-6.2a1 1 0 00-1-1h-.72A5.5 5.5 0 0112 4.5a5.5 5.5 0 015.72 3.8H17a1 1 0 00-1 1V15a1 1 0 001 1h.2A3.3 3.3 0 0114 19.1"
      stroke="#F6F6F6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
    <rect x="4.3" y="10.8" width="2.7" height="5.2" rx="1.35" fill="#F6F6F6"/>
    <rect x="17" y="10.8" width="2.7" height="5.2" rx="1.35" fill="#F6F6F6"/>
    <circle cx="18.5" cy="6" r="4" fill="#e9c400" stroke="#150825" strokeWidth="1.1"/>
...
function App() {
  ...
  return (
    <div className="stars-bg" style={{ minHeight: '100dvh' }}>
      ...
      {/* BOTÃO FLUTUANTE — Suporte Prioritário (não é WhatsApp direto, leva pra peneira) */}
      <a
        href="https://suporte-prioritario.web.app"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Suporte Prioritário"
        style={{
          position: 'fixed',
          bottom: '22px',
          right: '18px',
          ...
          height: '56px',
          borderRadius: '50%',
          background: 'linear-gradient(135deg, #8b171a 0%, #4a0c0e 100%)',
          border: '1.5px solid rgba(233,196,0,0.45)',
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center',
          boxShadow: '0 10px 26px rgba(139,23,26,0.55), 0 3px 10px rgba(0,0,0,0.45)',
          zIndex: 60,
          textDecoration: 'none',
        }}
      >
